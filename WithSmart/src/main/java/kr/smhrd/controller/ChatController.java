...
//        model.addAttribute("gp_id", chatMapper.getGroupMember(gp_id));
//        return "chatMember";
//    }
//
//    @RequestMapping("/showMessage")
//    public String showMessage(Model model, @RequestParam(name = "gp_id", required = false) Integer gp_id) {
//        model.addAttribute("gp_id", chatMapper.getGroupChatMessage(gp_id));
//        return "chatMessage";
//    }
//    
...
//    public String addMember(Integer gp_id, String mb_id, Chat chat) {
//        if (gp_id != null) {

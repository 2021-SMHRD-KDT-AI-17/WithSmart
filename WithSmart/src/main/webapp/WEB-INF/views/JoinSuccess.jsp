                     ...
                     <!-- Menu -->
                        <div id="Update">   
                           <ul class="actions vertical">
                              ...
                              <div class="btn_login"><button class="btn btn-primary" display :inline-block; style="background: #2E9AFE; border:none" ><a href ="goJoin", style ='color:white' >로그인 하러가기</a></button></div>
                              <br>

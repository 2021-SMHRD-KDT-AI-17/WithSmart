 ...
 <!-- header 파일 불러오기 -->
    ...
    <div class="row">
      ...
      <table id="list">
     	 ...
     	 <!-- 글 작성 입력 폼 -->
        <form action ="UpdatePboard?projectboard_idx=${projectboard.projectboard_idx }" method ="post" enctype="multipart/form-data">
          <div class="row" style ="margin-top: 50px" id="Friendboard">
            <div class="col-md-6">
              <div class="form-group">
              <!--  글 제목 입력  -->
                <label class="text-black" for="fname">제목</label>
                <input type="text" class="form-control" name="title" value="${projectboard.title }">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
              <!-- 작성자 입력  -->
                ...
                <input type="text" class="form-control" name ="writer" readonly value="${projectboard.writer }">
              </div>
            </div>
          </div>
    	 <div class="col-md-12">
   			<div class="form-group">
	       		<!-- 파일 첨부  -->
	       		<input type="file" style="float:right; margin-bottom: 20px;" name="filename">현재파일 : ${projectboard.filename}
	  	    </div>
        </div>
          <div class="form-group">
            <!--글 내용 입력  -->
            <label class="text-black" for="contents">내용</label>
            <textarea name="content" class="form-control" cols="30" rows="10">${ projectboard.content}</textarea>
          </div>

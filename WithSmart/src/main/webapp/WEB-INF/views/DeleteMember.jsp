                     ...
                     <!-- Menu -->
                        <div id="Update">   
                           <ul class="actions vertical">
                              <br>
                              <div><h1> 다시 한번 고민해보실래요? </h1></div>
                              <br>
                              <br>
                              <!-- Q2. 회원가입 한 회원정보 중 이메일을 출력하시오.(request영역 활용) -->
                              <div> 헤어지기 아쉬워요</div>
                              <div><strong>위드스마트</strong>는 항상 여러분을 기다립니다.</div>
                              <br>
                              <!-- <div id=loginButton><button onclick='location.href="goJoin"'>로그인 하러가기</button></div> -->
                              <div class="btn_login"><button class="btn btn-primary" display :inline-block; style=" border:none" ><a href ="deletePMember?mb_id=${loginMember.mb_id } ", style ='color:white' >진짜로 삭제하기</a></button></div>
                              <div class="btn_login"><button class="btn btn-primary" display :inline-block; style="background: #2E9AFE; border:none" ><a href ="goMain", style ='color:white' >홈으로 가기</a></button></div>
                              <br>

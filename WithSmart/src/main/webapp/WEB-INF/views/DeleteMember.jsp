                     ...
                     <!-- Menu -->
                        <div id="Update">   
                           <ul class="actions vertical">
                              ...
                              <div class="btn_login"><button class="btn btn-primary" display :inline-block; style=" border:none" ><a href ="deletePMember?mb_id=${mb_id } ", style ='color:white' >진짜로 삭제하기</a></button></div>

			...
			<div class="table-responsive">
				<span><h1>질문 게시판</h1></span>													
	                <div class ="btn">
					  ...
					  <tbody>
					  	<c:forEach items="${q_list }" var="q" varStatus="qs">
				  ...
				  <ul class="pagination justify-content-center">
				    ...
				    <li class="page-item">
						    <c:if test="${currentPage > 1}">
						        <a class="page-link" href="goQnABoard?page=${currentPage - 1}">&laquo; 이전</a>
						    </c:if>
					</li>
						    ...
						    <c:forEach begin="1" end="${totalPages}" var="pageNum">
						        ...
						        <c:choose>
						            ...
						            <c:otherwise>
						                <a class="page-link" href="goQnABoard?page=${pageNum}">${pageNum}</a>
						            </c:otherwise>
						        </c:choose>
						        </li>
						    </c:forEach>
					...
					<li class="page-item">	
						    <c:if test="${currentPage < totalPages}">
						        <a class="page-link" href="goQnABoard?page=${currentPage + 1}">다음 &raquo;</a>
						    </c:if>
					</li>	    

    ...
    <div class="container article">
      <div class="row justify-content-center align-items-stretch">
	    ...
	    <table id="list">
	       	  ...
	       	  <tr>
	          	<td>제목</td>
	          	<td><h2>${studyboard.title }</h2></td>
	          </tr>
	          <tr>
	          	<td>작성자</td>
	          	<td>${studyboard.writer }</td>
	          </tr>
	          
	          <tr>
				<td>다운로드</td>
				<td><a href="resources/image/${studyboard.filename }" download>${studyboard.filename}</a></td>
			  </tr>
	          ...
	          <tr>	
	          	<td colspan="3" style="border: 3px solid #BDBDBD; width:1000px; height:600px; border-radius:10px; padding: 30px">
	          		<img alt="" src="resources/image/${studyboard.filename}" width="550"> 
	          		<br>
	          		<h4 style="margin-top: 20px; font-size:15px">${studyboard.content }</h4>
		...
		<!-- 답글 보기  -->
           ...
           <hr>
			    ...
			    <ul class="comment-list">
			        <c:forEach items="${sc_list}" var="sc" varStatus="scs">
			            <li class="comment">
			                <div class="comment-body">
			                    <!-- 답글 단 회원 이름 가져오기  -->
			                    <h3>${sc.writer}</h3>
			                    <!-- 답글 단 시간 가져오기 -->  
			                    <div class="meta">${sc.writetime}</div>
			                    <!-- 답글 내용 가져오기  --> 
			                    
			                  <%--   <p>${sc.cmtcontent }<button class="btn btn-info" style="margin-left: 30px" ><a href="Stboardcommentheart?cmt_idx=${sc.cmt_idx}&studyboard_idx=${studyboard.studyboard_idx}">추천하기</a></button></p> --%>
			                    <!-- 부트스트랩 아이콘 가져옴 -->
			                   <!--  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-heart-eyes" viewBox="0 0 16 16"> -->
			                    ...
			                    <!-- </svg> -->
			                    <span>${sc.cmtcontent}</span>
			                    <span><button class="lovebt" onclick="location.href='Stboardcommentheart?cmt_idx=${sc.cmt_idx}&studyboard_idx=${studyboard.studyboard_idx}'">좋아요♥ ${sc.heartcount}</button></span>
